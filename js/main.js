...
const translations = {
    en: {
        ...
        lecture_scaling_title: "Scaling Laravel: 1K → 5M Users",
        lecture_scaling_desc: "Practical comparison of architecture, DB, caching, queues, and infra at scale.",
        lecture_read: "Read",
        lecture_pdf: "PDF",
        lecture_pdf_en: "PDF EN",
        lecture_pdf_ar: "PDF AR",
        tag_database: "Database",
        tag_performance: "Performance",
        knowledge_all: "View all lectures",
        insights_eyebrow: "Insights",
        insights_title: "Short backend essays with real-world architecture decisions",
        insights_desc: "A growing library of practical system design notes you can read and share directly.",
        insights_all: "Browse all insights",
        insight_system_design_title: "System Design Fundamentals for Backend Engineers",
        insight_tag_system_design: "System Design",
        insight_system_design_desc: "How to move from \"it works on my machine\" to resilient architecture in production.",
        insight_read_article: "Read article",
        insight_more_articles: "More articles",
    ...
    ar: {
        ...
        insights_eyebrow: "المقالات",
        insights_title: "مقالات خلفية قصيرة بقرارات معمارية واقعية",
        insights_desc: "مكتبة متزايدة من ملاحظات system design العملية تقدر تقرأها وتشاركها مباشرة.",
        insights_all: "تصفح كل المقالات",
        insight_system_design_title: "أساسيات تصميم الأنظمة لمهندسي الخلفية",
        insight_tag_system_design: "System Design",
        insight_system_design_desc: "كيف تنتقل من \"يعمل عندي\" إلى معمارية موثوقة في الإنتاج.",
        insight_read_article: "اقرأ المقال",
        insight_more_articles: "مقالات أكثر",
